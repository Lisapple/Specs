#
#  Be sure to run `pod spec lint TBTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of TBTableView in Markdown format.
  ...
  # s.authors          = { "Lisapple" => "me@lisacintosh.com", "other author" => "email@address.com" }
  # s.author           = 'Lisapple', 'other author'
  # s.social_media_url = "http://twitter.com/Lisapple"
